...
if(!function_exists("metabox_fields_infor_tour_callback")){
    function metabox_fields_infor_tour_callback($post){
        ...
        <p><span>Số lượt xem: </span> <input type="text" name="infor_tour[views]" value="<?php echo $value['views']?>"></p>
        <p><span>Giảm giá: </span> <input type="text" name="infor_tour[saleof]" value="<?php echo $value['saleof']?>">%</p>
        <?php
    }
}
