...
while (have_posts()) : the_post(); ?>
    ...
    <div class="listLink">
        <div class="grid-container">
            <div class="topLink">
                <div class="item">
                    <a href="<?php echo get_permalink(13335)?>" title="MOT DU FONDATEUR"><img src="//asia-soleil-travel.com/wp-content/uploads/2017/05/directeur-asia-soleil-travel-180x180.jpg" alt="MOT DU FONDATEUR"></a>
                    <h4><a href="<?php echo get_permalink(13335)?>" title="MOT DU FONDATEUR">MOT DU FONDATEUR</a></h4>
                </div>
            </div>
            <div class="linkMain displayFlex">
                <div class="item">
                    <div class="content displayFlex alignCenter">
                    <a href="<?php echo get_permalink(13280)?>" title="Notre équipe">
                        <img src="//asia-soleil-travel.com/wp-content/uploads/2017/05/Notre-equipe-180x180.jpg" alt="Notre équipe">
                    </a>
                    <h4><a href="<?php echo get_permalink(13280)?>" title="Notre équipe">Notre équipe</a></h4>
                    </div>
                </div>
                <div class="item">
                    <div class="content displayFlex alignCenter">
                    <a href="<?php echo get_permalink(13285)?>" title="Nos bureaux">
                        <img src="//asia-soleil-travel.com/wp-content/uploads/2017/05/Bureaux-1-180x180.jpg" alt="Nos bureaux">
                    </a>
                    <h4><a href="<?php echo get_permalink(13285)?>" title="Nos bureaux">Nos bureaux</a></h4>
                    </div>
                </div>
                <div class="item">
                    <div class="content displayFlex alignCenter">
                    <a href="<?php echo get_permalink(13288)?>" title="NOS EXPLORATEURS ET NOS GUIDES">
                        <img src="//asia-soleil-travel.com/wp-content/uploads/2017/05/IMG_0683-180x180.jpg" alt="NOS EXPLORATEURS ET NOS GUIDES">
                    </a>
                    <h4><a href="<?php echo get_permalink(13288)?>" title="NOS EXPLORATEURS ET NOS GUIDES">NOS EXPLORATEURS ET NOS GUIDES</a></h4>
                    </div>
                </div>
                <div class="item">
                    <div class="content displayFlex alignCenter">
                    <a href="<?php echo get_permalink(13291)?>" title="VOYAGE RESPONSABLE">
                    ...
                    <h4><a href="<?php echo get_permalink(13291)?>" title="VOYAGE RESPONSABLE">VOYAGE RESPONSABLE</a></h4>
                    </div>
                </div>
                <div class="item">
                    <div class="content displayFlex alignCenter">
                ...
                <div class="item">
                    <div class="content displayFlex alignCenter">
                    <a href="<?php echo get_permalink(13294)?>" title="10 BONNES RAISONS POUR PARTIR AVEC AST">
                        <img src="//asia-soleil-travel.com/wp-content/uploads/2017/05/Raison1-180x180.jpg" alt="10 BONNES RAISONS POUR PARTIR AVEC AST">
                    </a>
                    <h4><a href="<?php echo get_permalink(13294)?>" title="10 BONNES RAISONS POUR PARTIR AVEC AST">10 BONNES RAISONS POUR PARTIR AVEC AST</a></h4>
                    </div>
                </div>
                <div class="item">
                    <div class="content displayFlex alignCenter">
                ...
                <div class="item">
                    <div class="content displayFlex alignCenter">
                    <a href="<?php echo get_permalink(13297)?>" title="Notre modalité & Condition">
                        <img src="//asia-soleil-travel.com/wp-content/uploads/2017/05/Raison4-180x180.jpg" alt="Notre modalité & Condition">
                    </a>
                    <h4><a href="<?php echo get_permalink(13297)?>" title="Notre modalité & Condition">Notre modalité & Condition</a></h4>
                    </div>
                </div>
                <div class="item displayFlex alignCenter">
                    <div class="content displayFlex alignCenter">
                    <a href="<?php echo get_permalink(13300)?>" title="Thai Binh Garden, Propriété d’ASIA SOLEIL TRAVEL">
                    ...
                    <h4><a href="<?php echo get_permalink(13300)?>" title="Thai Binh Garden, Propriété d’ASIA SOLEIL TRAVEL">Thai Binh Garden, Propriété d’ASIA SOLEIL TRAVEL</a></h4>
                    </div>
                </div>
                <div class="item">
                    <div class="content displayFlex alignCenter">
                    <a href="<?php echo get_permalink(13305)?>" title="Notre partenaire en France ">
                        <img src="//asia-soleil-travel.com/wp-content/uploads/2017/05/Partenaire-180x180.jpg" alt="Notre partenaire en France ">
                    </a>
                    <h4><a href="<?php echo get_permalink(13305)?>" title="Notre partenaire en France ">Notre partenaire en France </a></h4>
                    </div>
                </div>
                <div class="item">
                    <div class="content displayFlex alignCenter">
                    <a href="<?php echo get_permalink(13307)?>" title="Salon du tourisme à Paris">
                        <img src="//asia-soleil-travel.com/wp-content/uploads/2017/05/salontourisme-paris-180x180.jpg" alt="Salon du tourisme à Paris">
                    </a>
                    <h4><a href="<?php echo get_permalink(13307)?>" title="Salon du tourisme à Paris">Salon du tourisme à Paris</a></h4>
                    </div>
                </div>
                <div class="item">
                    <div class="content displayFlex alignCenter">
                    <a href="<?php echo get_permalink(6609)?>" title="LES AVANTAGES AVEC UNE AGENCE LOCALE ">
                        <img src="//asia-soleil-travel.com/wp-content/uploads/2017/05/IMG_0680-180x180.jpg" alt="LES AVANTAGES AVEC UNE AGENCE LOCALE ">
                    </a>
                    <h4><a href="<?php echo get_permalink(6609)?>" title="LES AVANTAGES AVEC UNE AGENCE LOCALE ">LES AVANTAGES AVEC UNE AGENCE LOCALE </a></h4>
                    </div>
                </div>
                <div class="item">
                    <div class="content displayFlex alignCenter">
